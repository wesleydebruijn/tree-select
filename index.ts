...
function getData() {
  return [
    ...
    ...Array.from({ length: 10 }, (_, i) => ({
      id: `gen-${i + 1000}`,
      name: `Brand ${i + 1}`,
      children: Array.from({ length: 200 }, (_, j) => ({
        id: `gen-${i + 2000}-${j + 1}`,
        name: `${i + 1} Series ${String.fromCharCode(65 + (j % 26))}`,
        children: [
          {
            id: `gen-${i + 3000}-${j}-1`,
            name: `Model ${String.fromCharCode(65 + (j % 26))}1`,
          },
          {
            id: `gen-${i + 3000}-${j}-2`,
            name: `Model ${String.fromCharCode(65 + (j % 26))}2`,
          },
          {
            id: `gen-${i + 3000}-${j}-3`,
            name: `Model ${String.fromCharCode(65 + (j % 26))}3`,
          },
        ],
      })),
    })),
